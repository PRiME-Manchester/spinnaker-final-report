...
\usepackage{siunitx} % this needs to come after MinionPro, otherwise an error in MinionPro.sty is generated (line 170. You can't use a prefix with \begingroup). Bunch of warnings are also generated
\usepackage[usenames,dvipsnames]{xcolor} % color names
\usepackage{soul} % underline, highlight, etc

\usepackage{microtype}
\usepackage{graphicx}
\usepackage[round]{natbib}
%\usepackage{showframe} % shows page frame
...
% Equivalent to setting margins: top=30mm, bottom=30mm, left=35mm, right=30m
